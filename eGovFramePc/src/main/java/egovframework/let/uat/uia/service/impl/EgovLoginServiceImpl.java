...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
    	System.out.println( new String(EgovFileScrty.decodeBinary("JfQ7FIatlaE5jj7rPYO8QBABX8yb7bNbQy4AKY1QIfc="),"ksc5601"));
    	System.out.println( new String(EgovFileScrty.decodeBinary("JfQ7FIatlaE5jj7rPYO8QBABX8yb7bNbQy4AKY1QIfc="),"x-windows-949"));
    	System.out.println( new String(EgovFileScrty.decodeBinary("JfQ7FIatlaE5jj7rPYO8QBABX8yb7bNbQy4AKY1QIfc="),"iso-8859-1"));
    	System.out.println( new String(EgovFileScrty.decodeBinary("JfQ7FIatlaE5jj7rPYO8QBABX8yb7bNbQy4AKY1QIfc="),"utf-8"));

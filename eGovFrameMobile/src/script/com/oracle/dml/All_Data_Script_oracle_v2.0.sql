...
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM077', '멀티미디어구분', '멀티미디어 파일 유형 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM078', '최신구분', '최신 여부 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM079', '전송결과', 'MMS 전송결과 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM080', '요청결과', 'MMS 요청결과 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM081', 'OPEN-API 제공기관', 'OPEN-API 제공 기관코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM082', 'OPEN-API 서비스구분', 'OPEN-API 서비스 종류 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM083', '브라우저구분', '모바일 기기 브라우저 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM084', '운영체제구분', '모바일 기기 운영체제 구분코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM085', '등록상태', '등록 상태코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
INSERT INTO COMTCCMMNCODE(CL_CODE, CODE_ID, CODE_ID_NM, CODE_ID_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID,LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('EFC', 'COM086', '지역코드', '기상청 제공 지역코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');

...
public class ClubManageDAO extends EgovComAbstractDAO {
	...
	return (ClubVO)selectOne("ClubManageDAO.selectClubInf", clubVO);
    }
	...
	return (Integer)selectOne("ClubManageDAO.selectClubInfsCnt", clubVO);
    }
	...
	// 사용되지 않음 (EgovClubManageServiceImpl.selectClubUserInfs 메소드에서 사용되나 해당 메소드가 미사용 중)
	return (Integer)selectOne("ClubManageDAO.selectClubUserInfsCnt", clubUserVO);
    }
	...
	return (Integer)selectOne("ClubManageDAO.selectClubInfsCntByCmmntyId", clubVO);
    }
	...
	return (Integer)selectOne("ClubManageDAO.checkExistUser", clubUser);
    }
	...
	return (String)selectOne("ClubManageDAO.selectClubTmplat", clubVO);
    }
	...
	return (Integer)selectOne("ClubManageDAO.selectClubInfsCntByTrgetId", clubVO);
    }
	...
	return (ClubVO)selectOne("ClubManageDAO.selectCmmntyInf", clubVO);
    }
	...
	return (ClubUser)selectOne("ClubManageDAO.selectSingleClubUserInf", clubUser);
    }

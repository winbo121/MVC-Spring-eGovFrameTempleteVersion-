...
public class CmyBBSUseInfoManageDAO extends EgovComAbstractDAO {
	...
	return (Integer)selectOne("CmyBBSUseInfoManageDAO.selectBBSUseInfsCnt", bdUseVO);
    }
	...
	return (BoardUseInfVO)selectOne("CmyBBSUseInfoManageDAO.selectBBSUseInf", bdUseVO);
    }
	...
	return (Integer)selectOne("CmyBBSUseInfoManageDAO.selectBBSUseInfsCntByTrget", bdUseVO);
    }

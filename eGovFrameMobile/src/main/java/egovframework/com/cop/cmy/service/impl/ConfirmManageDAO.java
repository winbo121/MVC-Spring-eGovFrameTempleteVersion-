...
public class ConfirmManageDAO extends EgovComAbstractDAO {
	...
	return (Integer)selectOne("ConfirmManageDAO.selectConfirmRequestListCnt", historyVO);
    }
	...
	return (ConfirmHistoryVO)selectOne("ConfirmManageDAO.selectSingleConfirmRequest", historyVO);
    }
	...
	return (Integer)selectOne("ConfirmManageDAO.countConfirmRequest", history);
    }
}

...
public class CommunityManageDAO extends EgovComAbstractDAO {
	...
	return (Integer)selectOne("CommunityManageDAO.selectCommunityInfsCnt", cmmntyVO);
    }
	...
	// 사용되지 않음
	return (Integer)selectOne("CommunityManageDAO.selectCommunityUserInfsCnt", cmmntyUserVO);
    }
	...
	return (CommunityVO)selectOne("CommunityManageDAO.selectCommunityInf", cmmntyVO);
    }
	...
	return (String)selectOne("CommunityManageDAO.selectCmmntyTmplat", cmmntyVO);
    }
	...
	return (Integer)selectOne("CommunityManageDAO.checkExistUser", cmmntyUser);
    }
	...
	return (CommunityUser)selectOne("CommunityManageDAO.selectSingleCommunityUserInf", cmmntyUser);
    }

...
public class EgovFileTool {
	...
	public static boolean getExistDirectory(String targetDirPath) throws Exception {
		...
		//2017.02.27 김준호 시큐어코딩(ES)-부적절한 예외 처리[CWE-253, CWE-440, CWE-754]
			...
			//e.printStackTrace();
			throw new EgovBizException("[EgovFileTool] : connection close fail");
		}
	...
	public static ArrayList<?> getExistDirectory(String baseDirPath, String targetDirPath, int cnt) throws Exception {
		...
		ArrayList subResult = new ArrayList<Object>();
	 ...
	 */
	public static String getLastModifiedDateFromFile(File f) throws Exception {
	 ...
	 * @return String result 최종수정일자를 문자열로 리턴한다.
	 */
	public static String getLastModifiedDateFromFile(String filePath) throws Exception {
	...
	public static ArrayList<?> getLastDirectoryForModifiedDate(String baseDirPath, String fromDate, String toDate) throws Exception {
	 ...
	 */
	public static boolean canRead(String filePath) throws Exception {
	 ...
	 */
	public static boolean canWrite(String filePath) throws Exception {
	 ...
	 */
	public static String getName(String filePath) throws Exception {
	...
	public static String deletePath(String filePath) throws Exception {
		...
		try {
			...
			if (!file.exists()) {
	        	...
	        	if(file.createNewFile()){
	        		LOGGER.debug("[file.createNewFile] file : Creation Success ");
	        	}else{
	        	    LOGGER.error("[file.createNewFile] file : Creation Fail ");
	        	}				
				file.getAbsolutePath();
			}
		//2017.02.27 김준호 시큐어코딩(ES)-부적절한 예외 처리[CWE-253, CWE-440, CWE-754]
	...
	public static boolean checkFileExstByName(String dir, String file) throws Exception {
		...
		if (srcDrctry.exists() && srcDrctry.isDirectory()) {
			...
			ArrayList<String> list = getSubFilesByName(fileArray, file);
	...
	public static boolean checkFileExstByExtnt(String dir, String eventn) throws Exception {
		...
		if (srcDrctry.exists() && srcDrctry.isDirectory()) {
			...
			File[] fileArray = srcDrctry.listFiles();
			ArrayList<String> list = getSubFilesByExtnt(fileArray, eventn);
			if (list != null && list.size() > 0) {
				result = true;
			}
		}
	...
	public static boolean checkFileExstByUpdtPd(String dir, String updtFrom, String updtTo) throws Exception {
		...
		if (srcDrctry.exists() && srcDrctry.isDirectory()) {
			...
			File[] fileArray = srcDrctry.listFiles();
			ArrayList<String> list = getSubFilesByUpdtPd(fileArray, updtFrom, updtTo);
			if (list != null && list.size() > 0) {
				result = true;
			}
		}
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesByAll(File[] fileArray) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesByName(File[] fileArray, String file) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesByExtnt(File[] fileArray, String extnt) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesByUpdtPd(File[] fileArray, String updtFrom, String updtTo) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesBySize(File[] fileArray, long sizeFrom, long sizeTo) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesByOwner(File[] fileArray, String owner) throws Exception {
		...
		for (int i = 0; i < fileArray.length; i++) {
			...
			if (fileArray[i].isDirectory()) {
				File[] tmpArray = fileArray[i].listFiles();
				ArrayList<String> list1 = getSubFilesByOwner(tmpArray, owner);
				if (list1 != null)
					list.addAll(list1);
		...
		try {
			if (file.exists()) {
	        	...
	        	if(new File(file.getParent()).mkdirs()){
	        		LOGGER.debug("[file.mkdirs] mkdirs : Creation Success ");
	        	}else{
	        	    LOGGER.error("[file.mkdirs] mkdirs : Creation Fail ");
	        	}
	...
	public static String deleteDirectory(String dirDeletePath) throws Exception {
			...
			if(fileList.length > 0){
				for (int i = 0; i < fileList.length; i++) {
					...
					if (f.isFile()) {
			        	//2017.02.17 김준호 시큐어코딩(ES)-부적절한 예외 처리[CWE-253, CWE-440, CWE-754]		        	
			        	if(f.delete()){
			        		LOGGER.debug("[file.delete] delete : Creation Success ");
			        	}else{
			        	    LOGGER.error("[file.delete] delete : Creation Fail ");
			        	}
					} else {
	...
	public static String deleteFile(String fileDeletePath) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getFileListByDate(String drctry, String updtDate) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static ArrayList<String> getSubFilesByDate(File[] fileArray, String updtDate) throws Exception {
	 ...
	 * @exception Exception
	 */
	public static Vector<ArrayList<String>> parsFileByChar(String parFile, String parChar, int parField) throws Exception {

		// 파싱결과 구조체
		Vector<ArrayList<String>> parResult = new Vector<ArrayList<String>>();
		...
		try {
			...
			if (file.exists() && file.isFile()) {
				...
				int filedCnt = 1;
				ArrayList<String> arr = new ArrayList<String>(); // 2011.10.21 보안점검 후속조치
	 ...
	 * @exception Exception
	 */
	public static Vector<ArrayList<String>> parsFileBySize(String parFile, int[] parLen, int parLine) throws Exception {
	...
	public static String deleteDirectory(String dirDeletePath, String dirOwner) throws Exception {
	 ...
	 * @return 성공하면 삭제된 절대경로, 아니면블랭크
	 */
	public static String deleteDirectory(String dirDeletePath, String fromDate, String toDate) throws Exception {
		...
		try {
			...
			if (f.exists() && f.isDirectory()) {
				...
				if (targetDirPath1.equals("")) {
		        	...
		        	//2017.02.17 김준호 시큐어코딩(ES)-부적절한 예외 처리[CWE-253, CWE-440, CWE-754]		        	
		        	if(targetDir.mkdirs()){
		        		LOGGER.debug("[file.mkdirs] targetDir : Creation Success ");
		        	}else{
		        	    LOGGER.error("[file.mkdirs] targetDir : Creation Fail ");
		        	}					
					// 디렉토리에 속한 파일들을 복사한다.
	...
	protected static void close(Closeable closable) {
		if (closable != null) {
			try {
				...
				LOGGER.error("[IOException] Try/Catch...IOException : " + ignore.getMessage());
			}
		}
	}
}

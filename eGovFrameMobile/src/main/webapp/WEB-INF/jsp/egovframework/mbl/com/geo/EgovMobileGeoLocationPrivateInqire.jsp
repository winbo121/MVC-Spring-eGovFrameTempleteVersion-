		...
		<script type="text/javascript" language="javascript" defer="defer">
	        ...
	        function successCallback(position) {
	        	...
	        	for (var i = 0; i < buildingList.length; i++) {        		
		        	var buildingLatLng = new kakao.maps.LatLng(buildingList[i].la, buildingList[i].lo);
	        		...
	        		infowindow = new kakao.maps.InfoWindow({ 
		        		content: buildingList[i].buldNm + '<br>' + buildingList[i].telno
		        	});
	                			...
	                			<div align="right">	
	                				<form id="searchVO" name="searchVO" method="post">
	                					...
	                					<select id="searchCondition" name="searchCondition" onchange="javascript:init();" data-role="none">
	                						...
	                						<option value="2000">2km 이내</option></select></p>
	               					</form>
	               				</div>
	               			</div>
	               		</div>

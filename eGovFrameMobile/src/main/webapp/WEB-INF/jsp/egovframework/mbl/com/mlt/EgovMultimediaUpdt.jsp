...
<body onLoad="fn_egov_initl_multimedia();">
	...
	<form:form modelAttribute="multimedia" name="multimedia" action="" method="post"  enctype="multipart/form-data">
			    ...
			    <tr> 
			        ...
			        <td >
			            <c:import charEncoding="utf-8" url="/cmm/fms/selectFileInfsForUpdate.mdo" >
			                <c:param name="param_atchFileId" value="${egovc:encrypt(multimedia.atchFileId)}"/>
			            </c:import>                             
			        </td>
			    </tr>
			</c:if>
